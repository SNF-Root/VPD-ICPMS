...
G0 Z3.0 F300 ; lower to wipe height
; 
; BEGIN SCAN WAFER
G91 ; set relative coordinates
M82 ; set extruder to absolute coordinates
G0 X2.5 F3000 ; move to beginning of first circle
G1 E0 F5 ; extrude droplet
G2 I-2.5 F80.0 ; wipe a clockwise circle
G1 X5 F80.0 ; move to next circle circumnference
G2 I-7.5 F80.0 ; wipe a clockwise circle
G1 X5 F80.0 ; move to next circle circumnference
G2 I-12.5 F80.0 ; wipe a clockwise circle
G1 X5 F80.0 ; move to next circle circumnference
G2 I-17.5 F80.0 ; wipe a clockwise circle
G1 X5 F80.0 ; move to next circle circumnference
G2 I-22.5 F80.0 ; wipe a clockwise circle
G1 X5 F80.0 ; move to next circle circumnference
G2 I-27.5 F80.0 ; wipe a clockwise circle
G1 X5 F80.0 ; move to next circle circumnference
G2 I-32.5 F80.0 ; wipe a clockwise circle
G1 X5 F80.0 ; move to next circle circumnference
G2 I-37.5 F80.0 ; wipe a clockwise circle
G90 ; set absolute coordinates
G1 X110.2 Y129.3 F80.0 ; move to wafer center
; 
; BEGIN COLLECT DROPLET
G1 Z1 F100 ; lower closer to wafer
G1 E0.1 F2.5 ; slowly suck up droplet
G0 Z3.0 F100 ; raise to wipe height
; 
; BEGIN DISPENSE
G0 Z50 F300 ; move to safe travel height
