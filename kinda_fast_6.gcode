...
G0 Z0.75 F500 ; lower to wipe height
; 
; BEGIN SCAN WAFER
...
G2 I-2.5 F600.0 ; wipe a clockwise circle
G1 X5 F600.0 ; move to next circle circumnference
G2 I-7.5 F600.0 ; wipe a clockwise circle
G1 X5 F600.0 ; move to next circle circumnference
G2 I-12.5 F600.0 ; wipe a clockwise circle
G1 X5 F600.0 ; move to next circle circumnference
G2 I-17.5 F600.0 ; wipe a clockwise circle
G1 X5 F600.0 ; move to next circle circumnference
G2 I-22.5 F600.0 ; wipe a clockwise circle
G90 ; set absolute coordinates
G1 X110.2 Y129.3 F600.0 ; move to wafer center
; 
; BEGIN COLLECT DROPLET
G1 Z1 F300 ; lower closer to wafer
G1 E0.06 F2.5 ; slowly suck up droplet
G0 Z0.75 F300 ; raise to wipe height
; 
; BEGIN DISPENSE
G0 Z35 F500 ; move to safe travel height
