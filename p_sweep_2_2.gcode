...
G0 X5.0 F15000 ; move to circle circumference
G1 E0 F5 ; extrude droplet
G2 I-5.0 F50 ; wipe a clockwise circle
G1 X-5.0 F50 ; return to center of circle
...
G91 ; set relative coordinates
M82 ; set extruder to absolute coordinates
G0 X12.5 F15000 ; move to circle circumference
G1 E0 F5 ; extrude droplet
G2 I-12.5 F50 ; wipe a clockwise circle
G1 X-12.5 F50 ; return to center of circle
G90 ; set absolute coordinates
; 
; BEGIN COLLECT DROPLET
G1 Z1 F300 ; lower closer to wafer
...
G91 ; set relative coordinates
M82 ; set extruder to absolute coordinates
G0 X20.0 F15000 ; move to circle circumference
G1 E0 F5 ; extrude droplet
G2 I-20.0 F50 ; wipe a clockwise circle
G1 X-20.0 F50 ; return to center of circle
G90 ; set absolute coordinates
; 
; BEGIN COLLECT DROPLET
G1 Z1 F300 ; lower closer to wafer
...
G91 ; set relative coordinates
M82 ; set extruder to absolute coordinates
G0 X27.5 F15000 ; move to circle circumference
G1 E0 F5 ; extrude droplet
G2 I-27.5 F50 ; wipe a clockwise circle
G1 X-27.5 F50 ; return to center of circle
G90 ; set absolute coordinates
; 
; BEGIN COLLECT DROPLET
G1 Z1 F300 ; lower closer to wafer
...
G91 ; set relative coordinates
M82 ; set extruder to absolute coordinates
G0 X35.0 F15000 ; move to circle circumference
G1 E0 F5 ; extrude droplet
G2 I-35.0 F50 ; wipe a clockwise circle
G1 X-35.0 F50 ; return to center of circle
G90 ; set absolute coordinates
; 
; BEGIN COLLECT DROPLET
G1 Z1 F300 ; lower closer to wafer
