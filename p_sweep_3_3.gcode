...
G2 I-15.0 F300 ; wipe a clockwise circle
G1 X-15.0 F300 ; return to center of circle
...
G1 E0 F5 ; extrude droplet
G2 I-22.5 F300 ; wipe a clockwise circle
G1 X-22.5 F300 ; return to center of circle
G90 ; set absolute coordinates
; 
; BEGIN COLLECT DROPLET
G1 Z1 F300 ; lower closer to wafer
...
G1 E0 F5 ; extrude droplet
G2 I-30.0 F300 ; wipe a clockwise circle
G1 X-30.0 F300 ; return to center of circle
G90 ; set absolute coordinates
; 
; BEGIN COLLECT DROPLET
G1 Z1 F300 ; lower closer to wafer
...
G1 E0 F5 ; extrude droplet
G2 I-37.5 F300 ; wipe a clockwise circle
G1 X-37.5 F300 ; return to center of circle
G90 ; set absolute coordinates
; 
; BEGIN COLLECT DROPLET
G1 Z1 F300 ; lower closer to wafer
...
G1 E0 F5 ; extrude droplet
G2 I-45.0 F300 ; wipe a clockwise circle
G1 X-45.0 F300 ; return to center of circle
G90 ; set absolute coordinates
; 
; BEGIN COLLECT DROPLET
G1 Z1 F300 ; lower closer to wafer
